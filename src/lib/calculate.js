...
export function calculate(dach, ausrichtung, neigung, verbrauch, speicherKwh, eauto, waermepumpe, pvgisData, dachform, eautoProfil, tageszeit) {
  ...
  // autarkieSchaetzung()-Aufrufe und nicht als eigene Faustregel: Invariante 4
  // aus CLAUDE.md verlangt, dass Haupt- und Speicher-Rechner denselben
  // Mehr-Eigenverbrauch liefern, und genau diese Kennlinie ist die Quelle.
  ...
  return { kwp, module, nutzbar: Math.round(nutzbar), jahresertrag, eigenverbrauch, einspeisung, jahresErsparnis, investition, amortisation, einspeiseRate, co2, co2Baeume, ersparnis25, ersparnis10, ersparnis15, ersparnis20, gesamtVerbrauch, autarkie, monatlich, dataSource, monthly, eigenverbrauchsquote, balance, speicherBeitrag };
}
