// PLZ-Auflösung ohne Netzwerk-Aufruf — 1:1 aus dem pvrechner-Quellprojekt
// übernommen (dort validiert). Vorher fragte diese Datei für JEDE eingegebene
// PLZ Nominatim/OpenStreetMap direkt aus dem Browser ab. Das war gleich
// dreifach problematisch: die Nutzer-IP ging ungefragt an einen Dritten (in
// der Datenschutzerklärung nicht genannt), der mitgeschickte User-Agent-Header
// wird vom Browser ohnehin verworfen (Nominatim verlangt ihn aber laut
// Nutzungsrichtlinie), und ohne Debounce/Cache lief pro Tastendruck eine
// Anfrage. Straßengenaue Koordinaten liefert jetzt geocode.js — aber nur,
// wenn der Nutzer aktiv eine Adresse eintippt.
export const PLZ_MAP = {
  // Saarland (Heimatregion der PPC GmbH)
...
export function getCity(plzInput) {
